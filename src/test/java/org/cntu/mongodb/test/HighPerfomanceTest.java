...
public class HighPerfomanceTest {
    private MongoClient client;
    private MongoDatabase supermongo;
    private MongoCollection<Document> salesmen;
    private MongoCollection<Document> socialPerformanceRecord;
    ...
    void setUp() {
        ...
        socialPerformanceRecord = supermongo.getCollection("socialPerformanceRecord");
    }
